...
def zhimeihui(html):
    ...
    for i in range(len(title_list)):
        title = title_list[i]
        link = PublicGdutWebVar.url_pre + link_list[i]
...
def humanity_campus(html):
    title_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3left']/div[@class='main3leftc'][2]//li/a/text()")
    link_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3left']/div[@class='main3leftc'][2]//li/a/@href")
...
def study_section(html):
    title_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3left']/div[@class='main3leftc'][3]//ul/li/a/text()")
    link_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3left']/div[@class='main3leftc'][3]//ul/li/a/@href")
...
def graduate_people(html):
    title_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3right']/div[@class='main3rightc'][3]/div[@class='main3rightcon']/ul[@class='textlistul']/li/div/a/text()")
    link_list = html.xpath("//div[@class='main']/div[@class='mainc']/div[@class='main3']/div[@class='main3right']/div[@class='main3rightc'][3]/div[@class='main3rightcon']/ul[@class='textlistul']/li/div/a/@href")
